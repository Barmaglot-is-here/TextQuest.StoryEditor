...
{
    public class FileListTest : MonoBehaviour
    {
        [SerializeField]
        ...
        {
            ListItem selectedListItem1;

            if ((selectedListItem1 = selection.GetComponent<ListItem>()) != null)
            {
                SelectedItem = selectedListItem1;
